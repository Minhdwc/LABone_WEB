import { warrantyPolicyVN } from '@/lib/warranty-policy'

export default function WarrantyPolicyPage() {
  const content = warrantyPolicyVN
  ...
  return (
    <div className='w-full bg-white min-h-screen'>
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12'>
        ...
        {/* Covered Cases */}
        <div className='mb-8'>
          <h2 className='text-2xl font-bold text-black mb-4'>1. Trường hợp được bảo hành:</h2>
        ...
        {/* Not Covered Cases */}
        <div className='mb-8'>
          <h2 className='text-2xl font-bold text-black mb-4'>2. Trường hợp không được bảo hành:</h2>
          <div className='space-y-3'>
