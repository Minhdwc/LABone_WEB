'use client'
import { certificationDataEN } from '@/lib/certification-constants'
    ...
    <div className='w-full bg-white min-h-screen'>
      ...
      <div className='w-full bg-white py-6 sm:py-8'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6'>
          <h2 className='text-xl sm:text-2xl font-bold text-[#1e3a8a] text-center'>{certificationDataEN.title}</h2>
        </div>
      </div>
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 py-4 sm:py-6'>
        <div className='space-y-3 sm:space-y-4'>
          {certificationDataEN.certifications.map((certification) => (
            <div key={certification.id} className='bg-white border border-gray-300 rounded-lg overflow-hidden'>
              ...
              <button
                ...
                className='w-full flex items-center justify-between px-4 sm:px-5 py-3 sm:py-4 text-left hover:bg-gray-50 transition-colors duration-200 cursor-pointer'
              >
